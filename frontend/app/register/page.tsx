      ...
      <div className="card-minimal w-full max-w-lg rounded-2xl p-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          <button 
            ...
            className="w-full rounded-lg bg-black dark:bg-white py-4 text-sm font-bold text-white dark:text-black transition-all hover:bg-zinc-800 dark:hover:bg-zinc-200 disabled:opacity-50 md:col-span-2"
          >
